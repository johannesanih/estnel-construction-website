        ...
        <div id="cover-bg" class="text-light">
            <div id="blind">
                <div class="p-5 text-center" id="intro">
                    <h1 class="m-0 text-center" id="intro-1">You Imagine</h1>
                    <h1 class="m-0 text-center" id="intro-2">We Construct</h1>
                </div>
            ...
            <div class="est-flex p-5" id="about-1">
                <div class="p-2 w-60 pe-4">
                    <h1 class="display-5" id="about-title">
                        We Are a Leading Construction and Engineering Company
                    </h1>
                    <p>
