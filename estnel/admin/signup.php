...
<body class="p-0 bg-dark">
    <div class="container-fluid m-0 p-0">
        ...
        <div class="est-flex my-5" id="signup-div">
            <div id="signup-form">
                <div class="m-2">
                    <span class="d-block display-6 text-center text-danger">Admin Sign Up</span>
                </div>
                <div class="m-2">
                ...
                <div class="m-2">
                    <input type="password" class="d-block est-input bg-white" name="c_password" id="c_password-inp" placeholder="Confirm Password">
                </div>
                <div class="m-2">
                    <button class="d-block w-100 btn btn-lg btn-danger" id="signupBtn">Sign Up</button>
                </div>
                <div class="m-2 text-center text-muted">
                    Already have an account? <a href="signin.php" class="text-danger text-decoration-underline">Sign In</a>
                </div>
            </div>
        </div>
